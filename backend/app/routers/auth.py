...
# ============================================================
# ROUTER — final routes will be: /api/auth/...
# ============================================================
router = APIRouter(tags=["Auth"])  # ✅ FIXED: removed prefix="/auth"


# ============================================================
# CONFIG
# ============================================================
SECRET_KEY = "CHANGE_THIS_TO_A_LONG_RANDOM_SECRET_KEY_987654321"
ALGORITHM = "HS256"
...
# ============================================================
# CREATE FIRST SUPERADMIN (RUN ONLY ONCE)
# ============================================================
@router.post("/init-superadmin")
def init_superadmin(db: Session = Depends(get_db)):
    """
    Creates the first SuperAdmin if none exists.
    ...
    superadmin = models.User(
        ...
        passwordHash=pwd.hash("SuperAdmin@123"),
        role="SuperAdmin",
        department="IT",
    )
